...
export async function getServerSideProps() {
  const res = await fetch('https://frontend2-n8o4ivd2b-kuntapat002.vercel.app/api/users/');
...
export default function Component({ posts }) {
  ...
  const handleDelete = async (id) => {
    ...
    if (result.isConfirmed) {
      ...
      await fetch('https://frontend2-n8o4ivd2b-kuntapat002.vercel.app/api/users/' + id, {
        method: 'DELETE',
      });
