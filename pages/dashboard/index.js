...
export async function getServerSideProps() {
  const res = await fetch('https://frontend2-3vpvbu8k4-kuntapat002.vercel.app/api/users/');
...
export default function Component({ posts }) {
  ...
  const handleDelete = async (id) => {
    ...
    if (result.isConfirmed) {
      ...
      await fetch('https://frontend2-3vpvbu8k4-kuntapat002.vercel.app/api/users/' + id, {
        method: 'DELETE',
      });
